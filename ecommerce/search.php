	      ...
	      <section class="content">
	        <div class="row">
	            ...
	            <?php
	       			...
	       			$stmt = $conn->prepare("SELECT COUNT(*) AS numrows FROM products WHERE name LIKE :keyword OR price LIKE :keyword ");
	       			...
	       			if($row['numrows'] < 1){
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE name LIKE :keyword OR price LIKE :keyword");
						    $stmt->execute(['keyword' => '%'.$_POST['keyword'].'%']);
